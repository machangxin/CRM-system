...
<body>
	...
	<div class="layui-fluid">
		<div class="layui-row layui-col-space15">
			<div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
				<blockquote class="layui-elem-quote">CRM后台登陆界面</blockquote>
			</div>
		</div>
	</div>
	<!-- Head End -->
	...
	<div class="zyl_lofo_main">
		<fieldset class="layui-elem-field layui-field-title zyl_mar_02" action="loginaction">
			<legend>欢迎登陆 - CRM后台管理平台</legend>
		</fieldset>
		<div class="layui-row layui-col-space15">
			<form class="layui-form zyl_pad_01" method="post" action="loginaction">
				<div class="layui-col-sm12 layui-col-md12">
					<div class="layui-form-item">
						<input type="text" name="login_name" lay-verify="required|userName"
				...
				<div class="layui-col-sm12 layui-col-md12">
					<div class="layui-form-item">
						<input type="password" name="login_pass" lay-verify="required|pass"
